                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            <Link className="nav-link dropdown-toggle" to="#" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i className="fas fa-bell fa-fw text-dark" />
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            <Link className="nav-link dropdown-toggle" to="#" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i className="fas fa-envelope fa-fw text-dark" />
                        ...
                        <li className="nav-item dropdown no-arrow">
                            <Link className="nav-link dropdown-toggle" to="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span className="mr-2 d-none d-lg-inline text-dark font-weight-bold">John Smith</span>
                                <img className="img-profile rounded-circle" alt=""
                                    src="https://lh3.googleusercontent.com/-VDq0B0UNPNs/AAAAAAAAAAI/AAAAAAAAAAA/AFsW0b7epeAQOGvbf-Sgcgpi748fxjVkoQ/photo.jpg?sz=46" />
                            </Link>
                            <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <Link onClick={this.logOut} className="dropdown-item" to="#" data-toggle="modal" data-target="#logoutModal">
